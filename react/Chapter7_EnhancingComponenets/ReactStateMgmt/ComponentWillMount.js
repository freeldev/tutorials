...
// we use getFakeMembers function to request members

getFakeMembers(5).then(
  memers => console.log(members),
  err => console.error(new Error())
);

// use the getFakeMembers request to populate members component

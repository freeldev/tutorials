...
// we are able to make all the ajax calls in parallel, but the returned function statement of each thunk allows for us
// to ensure the order of the printing statements because the return functions of th2 and th3 rely upon the completion of th1
